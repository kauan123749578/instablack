...
class Settings(BaseSettings):
    ...
    # Username do dono da plataforma (único com painel Owner no /admin).
    # Deve ser EXATAMENTE o @ de login (ex.: kauawqi). Errado = você vira só Admin.
    owner_username: str = "kauawqi"
